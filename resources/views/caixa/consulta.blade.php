        ...
        <a href="" class="a-info-box">
          <div class="info-box text-dark">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Nº de transações : <span class="font-weight-bold">{{ count($contas) }}</span></span>
            </div>
          </div>
        </a>  
      </div>
        ...
        <a href="" class="a-info-box">  
          <div class="info-box text-dark">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{ collect($contas)->sum('vMulta') }},00MT</span>
            </div>
          </div>
        </a>
      </div>
        ...
        <a href="" class="a-info-box">
          <div class="info-box text-dark">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{ collect($contas)->sum('opcao1') }},00MT</span>
            </div>
          </div>
        </a>
      </div>
            ...
            <table id="exemple" class="table table-sm table-bordered table-hover table-head-fixed projects text-nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">{{ $conta->emprestimo_id }}</td>
                  <td>{{ $conta->emprestimo->cliente->nome }} {{ $conta->emprestimo->cliente->apelido }}</td>
                  <td class="text-center">{{ $conta->emprestimo->referencia }}</td>
                  <td class="text-center">{{ $conta->numero }}</td>
                  <td>{{ $conta->opcao1 }}</td>
                  <td>{{ $conta->vMulta }}</td>
                  <td>{{ $conta->user->nome }} {{ $conta->user->apelido }}</td>
                </tr>
                @empty
                <tr>
